...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStaticTheme}/base-global.css" type="text/css" rel="stylesheet" />
	<link href="${ctxStaticTheme}/common.css" type="text/css" rel="stylesheet" />
	<link href="${ctxStaticTheme}/website.css" type="text/css" rel="stylesheet" />
</c:if>